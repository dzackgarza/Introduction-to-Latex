...
% Choose a theme (my favourite is Boadilla)
\usetheme{Boadilla}

% Extend the standard sansmath font 
...
\begin{frame}{Proof}
    ...
    \begin{alertblock}{Proof (Step 2)}
         Notice that $a^2/b^2=(\sqrt{2})^2=2$, which implies $a^2=2b^2$, i.e. $2\mid a^2$. This means that $2\mid a$ (by this week's trivia problem!) and, consequently, that $4\mid a^2=2b^2$. From this we get that $2\mid b^2$, which (again, by this week's trivia problem!) implies $2\mid b$. 
    \end{alertblock}
    }
    
    \visible<3->{
    \begin{alertblock}{Proof (Step 3)}
         We have now seen that $2\mid a$ and that $2\mid b$, meaning that $\mathsf{gcd}(a,b)\geqslant 2$. But this contradicts our initial assumption. Hence, is \textbf{not} $\sqrt{2}$ rational.\hfill$\square$
     \end{alertblock}
    }
\end{frame}
...
\begin{frame}{A geometric proof}
    ...
    \visible<5->{This leads to the contradiction that $(2n-m):(m-n)=m:n$\,.}
